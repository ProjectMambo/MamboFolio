...
const mambo = localFont({
    src: [
        {
            path: "../../public/fonts/MamboFont-Regular_v0.0.0.woff2",
            weight: "400",
            style: "normal",
        },
        {
            path: "../../public/fonts/MamboFont-Medium_v0.0.0.woff2",
            weight: "500",
            style: "normal",
        },
        {
            path: "../../public/fonts/MamboFont-SemiBold_v0.0.0.woff2",
            weight: "600",
            style: "normal",
        },
        {
            path: "../../public/fonts/MamboFont-Bold_v0.0.0.woff2",
            weight: "700",
            style: "normal",
        },
    ],
